...
ActiveRecord::Schema.define(version: 20210503073620) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.string "instructor_of_attendances_log"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "basic_work_time", default: "2021-05-10 23:00:00"
    t.datetime "designated_work_start_time", default: "2021-05-11 00:00:00"
    t.datetime "designated_work_end_time", default: "2021-05-11 09:00:00"
    t.boolean "superior"
    t.boolean "admin"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
